...
export function TasteOnboarding({
  ...
  return (
    <div className="gate-overlay">
      <div className="gate-card gate-card-tall">
        <p className="eyebrow">{t('onboardEyebrow')}</p>
        <h2>
          {step === 'genres' ? t('onboardTitleGenres') : t('onboardTitleArtists')}
        </h2>
        <p className="sheet-desc">
          {step === 'genres' ? t('onboardLeadGenres') : t('onboardLeadArtists')}
        </p>
        {step === 'artists' && (
